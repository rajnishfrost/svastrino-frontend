...
const ICON = {
  ...
  // Enquiries — speech bubble (messages from the public forms)
  enquiries: <Svg><path d="M4 4h16v12H7l-3 3V4z" /><path d="M8 9h8" /><path d="M8 12.5h5" /></Svg>,
  // Support — headset (conversations with students, and reopening a locked course)
  tickets: <Svg><path d="M4 14v-2a8 8 0 0 1 16 0v2" /><path d="M4 14h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1Z" /><path d="M20 14h-2a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1Z" /><path d="M20 19a3 3 0 0 1-3 3h-4" /></Svg>,
  // Users — people
...
const NAV = [
  ...
  // Guarded by 'users', same as the API — whoever handles people handles enquiries.
  { label: 'Enquiries', to: '/admin/enquiries', icon: 'enquiries', module: 'users' },
