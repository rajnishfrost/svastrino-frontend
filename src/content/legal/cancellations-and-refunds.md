...
1. the portion of the service already utilised;  
2. the applicable processing fee;  
3. any pending payment or other payable amount; and  
4. any non-refundable rescheduling charges already paid.
...
1. errors, omissions, inaccuracies or outdated information in content;  
2. temporary unavailability, technical failures or interruptions;  
3. personal injury or property damage arising from matters outside the Provider's reasonable control;  
4. unauthorised access, cyberattacks or security incidents despite reasonable security measures; or  
5. loss or corruption of data caused by circumstances beyond the Provider's reasonable control.
