...
export default function Contact() {
  ...
  const onSubmit = (e) => {
    e.preventDefault()
    // Scaffold: wire to /api/user/contact later. Nothing is emailed or saved yet.
    setSent(true)
  }
            ...
            <div className="rounded-2xl border border-brand-navy/5 bg-white p-6 shadow-xl shadow-brand-navy/5 md:p-8">
              {sent ? (
                ...
                <form onSubmit={onSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="inline-flex h-12 cursor-pointer items-center justify-center gap-2 rounded-lg border-0 bg-brand-crimson px-8 text-base font-semibold text-white shadow-sm transition-colors hover:bg-brand-crimson-dark"
                  >
                    Send message
                  </button>
                </form>
