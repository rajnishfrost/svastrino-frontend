...
// import Scholarship from './sections/Scholarship.jsx' // scholarship hidden for now
import './Nirmaan.css'

/**
 * Nirmaan — Skill Build detail page.
 * Sections: Hero · Benefits · How-it-works · Packages. On mount it adds
 * `.theme-nirmaan` to <body> so the whole chrome flips to the Nirmaan
 * green/brown palette; removed on unmount to restore the Svastrino theme.
 * (Scholarship section is temporarily hidden — see the commented block below.)
 */
