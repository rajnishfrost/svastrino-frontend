      ...
      <div className="container">
        <div className="mx-auto max-w-3xl rounded-2xl border border-nirmaan-sand bg-white p-8 text-center shadow-sm md:p-10">
          ...
          <button
            ...
            disabled={busy}
            className="mt-6 inline-flex h-12 items-center justify-center rounded-lg bg-nirmaan-green px-8 text-base font-semibold text-white shadow-sm transition-colors hover:bg-nirmaan-green-dark disabled:opacity-70"
          >
            {copy.cta}
          </button>
          ...
          {standing === 'trial' && (
            <p className="mt-3 text-sm text-nirmaan-brown-soft">
              You’re on the free trial — the Introduction and Week 1 are open.
            </p>
          )}
        </div>
      </div>
